...
export async function createRadarChart() {
  ...
  console.log("In createRadarChart, Data:", data);
  ...
  axisGrid
    ...
    .attr("fill", "white")
    .text((d) => Math.round((d * maxValue) / cfg.levels) + "%");
  // .text(function (d, i) {
  ...
  var radarLine = d3
    ...
    // .curve(d3.curveBasisClosed) HERE
    .radius(function (d) {
      // console.log("check d.value:", d.value)
  ...
  blobCircleWrapper
    ...
    .on("mouseover", function (d, i) {
      // console.log("i",i);  // Log the data bound to the hovered element
      // console.log("d",d);  // Log the data bound to the hovered element
      console.log("i.value", i.value); // Log the specific value
      var newX = parseFloat(d3.select(this).attr("cx")) - 10;
      var newY = parseFloat(d3.select(this).attr("cy")) - 10;

      //   tooltip
      //   .attr('x', rScale(i.value) * Math.cos(angleSlice * i - Math.PI / 2))
      //   .attr('y', rScale(i.value) * Math.sin(angleSlice * i - Math.PI / 2))
      //   .text(i.value.toFixed(2) + '%')  // Assuming d.value is the correct data field
